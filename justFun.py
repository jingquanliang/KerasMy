...
class WebSpider(object):
    ...
    def get_csrf_token(self):
        ...
        :return: csrfToken
        """
        page = requests.get(self.URL_OPEN)
        htmlText=page.text
        # print(htmlText)
    ...
    def login(self,paramsDatas):
        '''
        使用request方法，获取网页内容
        '''

        res = requests.post(self.URL_REQUEST,data=paramsDatas,headers = dict(referer=self.URL_REQUEST))
    ...
    def getContentWithPost(self,contentURL,paramsDatas):
        '''
        使用request方法，获取网页内容
        '''

        res = requests.post(contentURL,data=paramsDatas)
        # print (res.status_code)
        # print (res)
        # print (res.text)
        # res.encoding = 'GBK'
    ...
    def getContentWithGet(self):
        ...
        '''
        while True:
            res = requests.get(self.URL_REQUEST, auth=(self.UID, self.SECRET))
            # print (res.status_code)
            # print (res)
            # print (res.text)
            # res.encoding = 'GBK'
...
if __name__ == "__main__":
    ...
    #   "query":"SELECT location.country, count(ip) FROM ipv4 GROUP BY location.country;",
    #   "format":"json",
    #   "flatten":False
    # }
    Headers ={
    ...
    csrf_token=spider.get_csrf_token()
    ...
    job_id=spider.getContentWithPost(contentURL,jsonParams)
